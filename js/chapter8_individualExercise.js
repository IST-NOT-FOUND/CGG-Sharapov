...
function setupLights() {
    ...
    gl.uniform3fv(shaderProgram.uniformDiffuseLightColor, [3.7, 0.7, 0.7]);
    gl.uniform3fv(shaderProgram.uniformSpecularLightColor, [0.1, 6.0, 0.1]);
}
...
function setTextures(){
    ...
    image.src = "/CGG-Sharapov/img/texture.jpg";
